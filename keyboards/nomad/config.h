 ...
 * manufacturer specs.
 */
/* BrianY 2020-04-15: The default is 5 I believe. The S key (and to some degree the F key) was giving me
   trouble so this was tried to avoid the extra keysstrokes. Apparently it is still not perfect. */
#define DEBOUNCE 30
